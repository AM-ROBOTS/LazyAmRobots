...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
            InlineKeyboardButton("D͢o͢n͢a͢t͢e͢ 𝒜𝑀𝑅𝒪𝐵𝒪𝒯𝒮", callback_data="thdonatelazydev"),
            ],
        ...
        buttons = [
            [
            InlineKeyboardButton("D͢o͢n͢a͢t͢e͢ 𝒜𝑀𝑅𝒪𝐵𝒪𝒯𝒮", callback_data="linkdonatelazydev"),
            ],
            [ InlineKeyboardButton("<- G̳O̳ ̳B̳A̳C̳K̳  ⨳", callback_data="lazyhome") ]
            ]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ 𝙷𝚎𝚢 𝚜𝚘𝚗𝚊 `{message.from_user.first_name}` 😎,\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ ʜᴀꜱ ʙᴇᴇɴ ꜱᴇɴᴛ ᴛᴏ ᴏᴜʀ **ᴀᴅᴍɪɴ'ꜱ ᴅᴀꜱʜʙᴏᴀʀᴅ** !\nᴘʟᴇᴀꜱᴇ ᴋᴇᴇᴘ ꜱᴏᴍᴇ ᴘᴀᴛɪᴇɴᴄᴇ !\nᴛʜᴇʏ ᴡɪʟʟ ᴜᴘʟᴏᴀᴅ ɪᴛ ᴀꜱ ꜱᴏᴏɴ ᴀꜱ ᴘᴏꜱꜱɪʙʟᴇ.\n\n➟ 📝𝘾𝙤𝙣𝙩𝙚𝙣𝙩 𝙣𝙖𝙢𝙚 : `{search}`\n➟ 👮𝙍𝙚𝙦𝙪𝙚𝙨𝙩𝙚𝙙 𝘽𝙮 : `{message.from_user.first_name}`\n\n༺ @AMROBOTS_BOTS ༻\n\n🦋・‥☆𝘼𝘿𝙈𝙞𝙉 𝙨𝙪𝙥𝙥𝙤𝙧𝙩☆‥・🦋\n╰┈➤・☆ @@AM_ROBOTS\n╰┈➤・☆ @@AMROBOTS_BOTS",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("━ • │▌║  ᗩᗪᗪ ʍɛ 2 ᑌᖇ Ǥᖇᗝᑌᑭ  ║▌│ • ━", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("✪ Dev Ch- ✪", url="https://t.me/AMROBOTS_BOTS"), InlineKeyboardButton("✪ ＹＴ ✪", url="https://apnatube.in/@apnatube"), InlineKeyboardButton("✪ Main Ch- ✪", url="https://t.me/AMROBOTS_BOTS")],[InlineKeyboardButton("╚»♥️Thank u 𝒜𝑀𝑅𝒪𝐵𝒪𝒯𝒮™♥️«╝", callback_data="close_data")]]))
